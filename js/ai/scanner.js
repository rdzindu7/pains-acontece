const PAScanner = (function () {
  const RSS_FEEDS = [
    ...
    { url: 'https://news.google.com/rss/search?q=site:pains.mg.gov.br&hl=pt-BR&gl=BR&ceid=BR:pt-419', region: 'Pains', priority: 3 },
    { url: 'https://news.google.com/rss/search?q=Pains+MG+c%C3%A2mara+vereadores&hl=pt-BR&gl=BR&ceid=BR:pt-419', region: 'Pains', priority: 3 },
    { url: 'https://news.google.com/rss/search?q=Formiga+MG&hl=pt-BR&gl=BR&ceid=BR:pt-419', region: 'Região', priority: 3 },
    { url: 'https://news.google.com/rss/search?q=Piumhi+MG&hl=pt-BR&gl=BR&ceid=BR:pt-419', region: 'Região', priority: 3 },
    { url: 'https://news.google.com/rss/search?q=Bambu%C3%AD+MG&hl=pt-BR&gl=BR&ceid=BR:pt-419', region: 'Região', priority: 3 },
    { url: 'https://news.google.com/rss/search?q=Medeiros+MG&hl=pt-BR&gl=BR&ceid=BR:pt-419', region: 'Região', priority: 2 },
    { url: 'https://news.google.com/rss/search?q=Cristais+MG&hl=pt-BR&gl=BR&ceid=BR:pt-419', region: 'Região', priority: 2 },
    { url: 'https://news.google.com/rss/search?q=Pedra+do+Indai%C3%A1+MG&hl=pt-BR&gl=BR&ceid=BR:pt-419', region: 'Região', priority: 2 },
    { url: 'https://news.google.com/rss/search?q=S%C3%A3o+Sebasti%C3%A3o+do+Oeste+MG&hl=pt-BR&gl=BR&ceid=BR:pt-419', region: 'Região', priority: 2 },
    { url: 'https://news.google.com/rss/search?q=Alto+S%C3%A3o+Francisco+Mineiro&hl=pt-BR&gl=BR&ceid=BR:pt-419', region: 'Região', priority: 3 },
    { url: 'https://news.google.com/rss/search?q=Sudoeste+de+Minas+not%C3%ADcias&hl=pt-BR&gl=BR&ceid=BR:pt-419', region: 'Região', priority: 3 },
    { url: 'https://news.google.com/rss/search?q=Dores+do+Indai%C3%A1+MG&hl=pt-BR&gl=BR&ceid=BR:pt-419', region: 'Região', priority: 3 },
    { url: 'https://news.google.com/rss/search?q=Divin%C3%B3polis+MG+regi%C3%A3o&hl=pt-BR&gl=BR&ceid=BR:pt-419', region: 'Região', priority: 2 },
  ...
  const CAT_KEYWORDS = {
    ...
    'Pains': ['pains'],
    'Região': ['formiga', 'piumhi', 'dores', 'bambui', 'medeiros', 'cristais', 'pedra', 'sebastiao', 'sudoeste', 'alto sao francisco', 'regiao'],
